...
import com.acabra.calculator.function.CosFunction;
...
public class NewtonMethodTest {
    ...
    public void shouldCalculate_root_within_given_iterationsTest() {
        ...
        assertEquals(0.0, realFunction.evaluate(iterativeRootFindingResult.getApproximatedRoot()), WebCalculatorConstants.ACCURACY_EPSILON);
    ...
    public void shouldCalculate_root_within_given_iterations_and_tolerance_cosine_test() {
        RealFunction realFunction = new CosFunction();
        ...
        IterativeRootFindingResult iterativeRootFindingResult = newtonMethod.iterateMethod(200);
        assertEquals(0.0, realFunction.evaluate(iterativeRootFindingResult.getApproximatedRoot()), tolerance);
