...
public class WebCalculatorFactoryResponse {
    ...
    public static CalculationResponse createCalculationResponse(long id, String expression, long responseTime, IntegrableFunction solvedIntegral, String description) {
        return new IntegralCalculationResponse(id, false, expression, solvedIntegral.getSequenceRiemannRectangle(), solvedIntegral.getResult(), responseTime, description);
    }
    ...
    public static CalculationResponse createFailedCalculationResponse(long id, String expression, String token, long responseTime, String message) {
