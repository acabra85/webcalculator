...
let Rules = (function () {
    let AVAILABLE_LANGUAGES = [
        ...
        },
        {
            ...
            name: 'Русский',
            rulesLabel: 'Правила',
            rulesHTML: '<tr><th>Цель игры</th><td> Отгадай <b>секрет</b> противника</td></tr>' +
                '<tr><th>Секрет</th><td> Четыре цифры от 0000 до 9999</td></tr>' +
                '<tr><th>Fixes</th><td>Представлены как "<b>F</b>", это цифры в твоём "отгадывании", которые есть в секрете противника в правильной позиции.</td></tr>' +
                '<tr><th>Spikes</th><td>Представлены как "<b>S</b>", оставшиеся цифры с твоего "отгадывания" (Не Fixes), которые есть в секрете противника в неправильной позиции.</td></tr>' +
                '<tr><th>Ход</th><td> Игрок высылает <b>oтгадывание</b>, и получет результат в виде "F" и "S"</td></tr>' +
                '<tr><th>\Раунд</th><td> Состоит из 2 ходов (по одному на участника), количество ходов в игре не ограничено. </td></tr>' +
                '<tr><th>Игра заканчивается</th><td>когда в конце одного <b>раунда</b> игрок (или оба) угадали секреты противника (<b>4 Fixes</b>)</td></tr>'
        },
        {
            id: 'dk',
            name: 'Dansk',
        ...
        },
        {
            ...
            name: 'Беларускi',
            rulesLabel: 'Правілы',
            rulesHTML: '<tr><th>Мэта гульні</th><td> Адгадай <b>сакрэт</b> суперніка</td></tr>' +
                '<tr><th>Сакрэт</th><td> Чатыры лічбы ад 0000 да 9999</td></tr>' +
                '<tr><th>Fixes</th><td>Прадстаўлены як "<b>F</b>", гэта лічбы ў тваім "адгадванні", якія ёсць у сакрэце суперніка ў правільнай пазіцыі.</td></tr>' +
                '<tr><th>Spikes</th><td>Прадстаўлены як "<b>S</b>", застаўшыся цлічбы з твайго "адгадвання" (Не Fixes), якія ёсць у сакрэце суперніка ў няправільнай пазіцыі.</td></tr>' +
                '<tr><th>Ход</th><td>Гулец высылае <b>адгадванне</b>, і атрымае вынік у выглядзе "F" і "S"</td></tr>' +
                '<tr><th>\Раунд</th><td> Складаецца з 2 хадоў (па адным на ўдзельніка), колькасць хадоў у гульні не абмежавана.  </td></tr>' +
                '<tr><th>Гульня сканчаецца</th><td>калі ў канцы аднаго <b>раунда</b> гулец (або абодва) адгадалі сакрэты суперніка (<b>4 Fixes</b>)</td></tr>'
        },
        {
            id: 'pl',
            name: 'Polski',
